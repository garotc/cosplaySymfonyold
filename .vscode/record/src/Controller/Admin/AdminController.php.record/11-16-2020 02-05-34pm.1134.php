...
class AdminController extends AbstractController
{
    ...
    /**
     * @Route("/admin/categories", name="admin_aff_categorie")
     */
    public function affCategorie(CategorieRepository $repo): Response
    {
        $categorie = $this->getLibelleCategorie();
        $categories = $repo->findAll();
        return $this->render('admin/userAccount.html.twig', compact('categories','categorie'));
    }
