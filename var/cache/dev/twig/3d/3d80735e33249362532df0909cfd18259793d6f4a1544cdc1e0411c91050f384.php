...
class __TwigTemplate_8ca274552f16acdcfbe9fc28dcd884c42b5b3cbbff580f90d18fc11362c22add extends Template
{
    private $source;
    private $macros = [];
...
<div class=\"col-6 m-auto\">
    <div class=\"row\">
        ...
        // line 9
        echo twig_include($this->env, $context, "categorie/_form.html.twig", ["button_label" => "Modifier"]);
        echo "</div>
    </div>
...
<div class=\"col-6 m-auto\">
    <div class=\"row\">
        <div class='btn btn-dark'>{{ include('categorie/_form.html.twig', {'button_label': 'Modifier'}) }}</div>
    </div>
    
    <div class=\"row\">
        <a href=\"{{ path('categorie_index') }}\" class='btn btn-warning'>Retour</a>

        <div class='btn btn-danger'>{{ include('categorie/_delete_form.html.twig') }}</div>
    </div>
</div>
{% endblock %}
", "categorie/edit.html.twig", "C:\\wamp64\\www\\test\\cosplayProject\\templates\\categorie\\edit.html.twig");
    }
}
